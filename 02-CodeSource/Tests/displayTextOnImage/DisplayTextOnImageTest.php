    ...
    <div class="w-64 h-64 bg-red-100 relative">
        ...
        <div class="mt-[75px]">
            ...
            <div class="ml-[20%] mr-[20%] border-solid border-2 border-black flex justify-center">
                ...
                <!-- DETAILS DU LIVRE 1-->
                <img class="w-[33%]" src="book1.jpg" alt="">
                <!-- DETAILS DU LIVRE 1-->

                <!-- DETAILS DU LIVRE 2-->
                <div class="relative bg-[#C4C4C4] w-[33%]">
                        <ul class="absolute z-10 flex flex-col justify-center items-center inset-0">
                            <li>Nom : $artName</li>
                            <li>Auteur : $autor</li>
                            <li>
                                <input type="button" class="cursor-pointer hover:bg-opacity-[100%] rounded-full absolute z-30 bg-[#C4C4C4] bg-opacity-[35%] border-solid border-2 border-black text-[10px] h-[25px] w-[50px] sm:text-[10px] sm:h-[25px] sm:w-[50px] md:text-[20px] md:h-[50px] md:w-[100px] lg:text-[30px] lg:h-[75px] lg:w-[150px]" value="DETAILS">
                    ...
                    <img class="relative z-20 hover:z-10 hover:opacity-25 h-[100%]" src="book2.jpg" alt="">
                </div>
                <!-- DETAILS DU LIVRE 2-->
                
                <!-- DETAILS DU LIVRE 3-->
                <img class="w-[33%]" src="book3.jpg" alt="">
                <!-- DETAILS DU LIVRE 3-->
        ...
        <div class="mt-[75px]">
            ...
            <div class="ml-[20%] mr-[20%] border-solid border-2 border-black flex justify-center">
                ...
                <div class="relative bg-[#C4C4C4] w-[33%]">
                    ...
                    <div class="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex flex-col justify-center items-center text-6xl text-black font-semibold">
